...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{ $data->translatedFormat('F') }},{{ $data->day }},{{ $data->year }} • {{ $data->format('H:i') }} • {{ $post->comments->count() }} Комментарии</p>
            <section class="blog-post-featured-img" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <section class="comment_list mb-5">
                        <h2 class="section-title mb-5" data-aos="fade-up">Kомментарий ({{ $post->comments->count() }})</h2>
